...
1) Create a new directory (or ideally a subdirectoy of your `FANR6750\` directory) and call it `LastNameFirstName-Homework#`, replacing `LastNameFirstName` with your last and first names and `#` with the appropriate homework number
