...
1a) Create a new directory (or ideally a subdirectoy of your `FANR6750\` directory) and call it `LastNameFirstName-Homework#`, replacing `LastNameFirstName` with your last and first names and `#` with the appropriate homework number
...
2c) Scroll down through the options until you see `FANR6750-Homework#` (where `#` will be the appropriate homework number). Select that template 
