...
$$\large y_{j} = \beta_0 + \beta_1 x^1_j + \beta_2x^2_j + \beta_ax^a_j + \epsilon_{j}$$

$$\large \epsilon_{j} \sim normal(0, \sigma^2)$$
...
As discussed previously, ANOVA is a linear model ( $y = a + bx$ )
