---
title: "LECTURE 8: assumptions and transformations"
...
<br/>
--
**Question**: Is this a complete description of the model underlying ANOVA?  

<br/>
--
**Answer**: No, because it doesn't describe the random component of the model  

<br/>
--
A complete description requires this:
...
1) Within each treatment group, the data are normally distributed  
...
--
- The assumptions of ANOVA are made explicit by the additive model  
